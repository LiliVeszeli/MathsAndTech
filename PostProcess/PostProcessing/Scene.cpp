...
// This texture will have the scene renderered on it. Then the texture is used for post-processing
...
void PostProcessing(float frameTime)
{
	...
	if (gCurrentPostProcess == PostProcess::Tint)
	{
		...
		gPostProcessingConstants.tintColour = CVector3{0.5f, 0, 0.5f};
	}
