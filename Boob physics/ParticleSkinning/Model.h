...
public:
	...
	bool Load( const string& fileName, ID3D10EffectTechnique* shaderCode, bool tangents = false, int numSkinningParticles = 0, gen::CVector3* skinningParticles = 0, float skinningDist = 0.5f );
