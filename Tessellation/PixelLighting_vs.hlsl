...
// The domain shader does the displacement mapping - taking a height map from a texture and applying it to tessellated
// geometry to create high polygon bumpy geometry
