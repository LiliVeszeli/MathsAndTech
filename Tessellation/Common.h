...
struct PerModelConstants
{
	...
	float      minTessellation;           // Minimum tessellation factor, i.e. maximum detail level (used in hull shader patch constant function)
	float      maxTessellation;           // --"-- maximum
	float      minTessellationDistance;   // Distance at which *maximum* tessellation will be used (used in hull shader patch constant function)
	float      maxTessellationDistance;   // --"-- minimum
