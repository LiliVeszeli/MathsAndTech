...
// Construct a matrix from a quaternion - upper 3x3 is calculated, with remaining elements taken
...
{
	// The matrix is stored as individual elements: 
	//   e00, e01, e02, e03
	//   e10, e11, e12, e13
	//   e20, e21, e22, e23
	//   e30, e31, e32, e33
	// Fill in the elements using the formula in the lecture notes
	e00 = 1 - 2 * (quat.y * quat.y) - 2 * (quat.z * quat.z);
	e01 = 2 * quat.x * quat.y + 2 * quat.w * quat.z;
	e02 = 2 * quat.x * quat.z - 2 * quat.w * quat.y;
	e03 = 0;

	e10 = 2 * quat.x * quat.y - 2 * quat.w * quat.z;
	e11 = 1 - 2 * (quat.x * quat.x) - 2 * (quat.z * quat.z);
	e12 = 2 * quat.y * quat.z + 2 * quat.w * quat.x;
	e13 = 0;

	e20 = 2 * quat.x * quat.z + 2 * quat.w * quat.y;
	e21 = 2 * quat.y * quat.z - 2 * quat.w * quat.x;
	e22 = 1 - 2 * (quat.x * quat.x) - 2 * (quat.y * quat.y);
	e23 = 0;
