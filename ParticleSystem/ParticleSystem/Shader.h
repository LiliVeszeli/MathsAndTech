...
extern ID3D11VertexShader*   gWorldTransformOnlyVertexShader;
...
extern ID3D11GeometryShader* gParticleRenderShader; // Geometry shader used for rendering particles
extern ID3D11GeometryShader* gParticleUpdateShader; // Geometry shdaer used for updating particles
extern ID3D11VertexShader*   gParticlePassThruVertexShader; // Vertex shader does nothing when rendering and updating particles
