...
// Structure containing data for updating (not rendering) one particle on the GPU
struct ParticleData
{
	float3 position : position; // World position of particle
	float3 velocity : velocity; // World velocity of particle
	float  life     : life;     // Current life of particle (seconds)
};
