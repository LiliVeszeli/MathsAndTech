...
extern ID3D11VertexShader*   gParticlePassThruVertexShader;
extern ID3D11GeometryShader* gParticleGeometryShader;  // Geometry shader used to expand particle points into quads
extern ID3D11PixelShader*    gSoftParticlePixelShader; // Special pixel shader for soft particles - unlike other pixel shaders it works with the depth values as well as colours
