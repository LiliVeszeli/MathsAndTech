...
void VS_SingleXFormFn( int method, CMatrix4x4* worldMatrix, CCamera* camera );
void VS_XFormFn( int method, CMatrix4x4* worldMatrix, CCamera* camera );
void VS_VertLit2Fn( int method, CMatrix4x4* worldMatrix, CCamera* camera );
...
{
	"XFormOnly.vsh",    VS_SingleXFormFn, "PlainColour.psh",       PS_PlainColourFn, 0, 0, 0, 0,
	"XFormTex.vsh",     VS_SingleXFormFn, "TextureOnly.psh",       PS_FogFn,         0, 0, 0, 0,
	"XFormTex.vsh",     VS_SingleXFormFn, "TextureOnly.psh",       PS_NullFn,        0, 0, 0, 0,
	"VertexLit.vsh",    VS_VertLit2Fn,    "DiffuseColour.psh",     PS_FogFn,         0, 0, 0, 0,
	"VertexLitTex.vsh", VS_VertLit2Fn,    "DiffuseColourTex.psh",  PS_FogFn,         0, 0, 0, 0,
	"PixelLit.vsh",     VS_XFormFn,       "PixelLit.psh",          PS_PixelLit2Fn,   0, 0, 0, 0,
	"PixelLitTex.vsh",  VS_XFormFn,       "PixelLitTex.psh",       PS_PixelLit2Fn,   0, 0, 0, 0,
};
...
// Pass single combined world/view/projection matrix to the vertex shader
void VS_SingleXFormFn( int method, CMatrix4x4* worldMatrix, CCamera* camera )
{
...
// Pass data to vertex shaders that perform vertex lighting (2 point lights)
void VS_VertLit2Fn( int method, CMatrix4x4* worldMatrix, CCamera* camera )
{
	LPD3DXCONSTANTTABLE shaderConsts = renderMethods[method].vertexConsts;
...
void PS_FogFn( int method, CMatrix4x4* worldMatrix, CCamera* camera )
{
	...
	g_pd3dDevice->SetRenderState( D3DRS_FOGCOLOR, 0x101020 );
